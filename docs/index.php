...
<div id="wrap-main">
  ...
  <h3>What is The Pyi Framework?</h3>
  ...
  <h3>What can I make with Pyi?</h3>
  ...
  <h3>Couldn't I just do all this by hand?</h3>
  ...
  <p>Pyi comes with the following files..<br />
    ...
    <br />Plus, building a website in the subdirecty of a domain is not good practice.</p>
      <blockquote>
        <p><strong>There are two ways to install The Pyi Framework on your server.</strong></p>
        <p><strong>(1.</strong> upload the zip or tar.bz2 file and unzip it using your hosting file manager (such as cPanel > File manager).</p>
        <p><strong>(2.</strong> unzip the zip or tar.bz2 file with a program like 7zip and then upload the files.</p>
      </blockquote>
    ...
    <h3>How do I add more segments?</h3>
    ...
    <p><strong><em>* Building a website in a subdirectly is never a good idea. Treating a subdirectory as a root folder causes a lot of unexpected chaos with your links. But if you must, the Pyi Framework includes a way to do this. See below... *</em></strong></p>
    ...
    <h3>External Javascript Files</h3>
